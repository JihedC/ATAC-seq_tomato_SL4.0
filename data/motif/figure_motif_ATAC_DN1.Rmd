...
```{r}
knownResults <- read_delim("~/Dropbox/Work/ATAC-seq/atac_veronica/data/motif/less_accessible_in_KO/knownResults.txt", 
...
```
```{r}
ggsave(plot_log2, filename = "~/Dropbox/Work/ATAC-seq/atac_veronica/data/motif/Log2_Ranked_motif_less_accessible.pdf", dpi = 600)
ggsave(plot_log10, filename = "~/Dropbox/Work/ATAC-seq/atac_veronica/data/motif/Log10_Ranked_motif_less_accessible.pdf", dpi = 600)
```
