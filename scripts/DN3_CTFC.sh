...
computeMatrix \
    ...
    --binSize 10 \
    --skipZeros \
    -o DN3_ATAC_CTCF_centered.gz

plotProfile --matrixFile DN3_ATAC_CTCF_centered.gz --perGroup --outFileName profile_plot_DN3_ATAC_CTCF_centered.pdf

plotHeatmap --matrixFile DN3_ATAC_CTCF_centered.gz --outFileName heatmap_plot_DN3_ATAC_CTCF_centered.pdf --colorMap Reds