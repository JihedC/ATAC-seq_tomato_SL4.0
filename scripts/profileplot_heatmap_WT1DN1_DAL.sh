...
computeMatrix \
    ...
    --binSize 10 \
    --skipZeros \
    -o WT1_DN1_ATAC_DAL.gz

plotProfile --matrixFile WT1_DN1_ATAC_DAL.gz --perGroup --outFileName profile_plot_WT1_DN1_ATAC_DAL.pdf

plotHeatmap --matrixFile WT1_DN1_ATAC_DAL.gz --outFileName heatmap_plot_WT1_DN1_ATAC_DAL.pdf --colorMap Reds