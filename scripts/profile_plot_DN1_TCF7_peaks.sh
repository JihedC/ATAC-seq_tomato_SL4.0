...
computeMatrix \
    ...
    --binSize 10 \
    --skipZeros \
    -o DN1_ATAC_TCF7_diffbind_centered.gz

plotProfile --matrixFile DN1_ATAC_TCF7_diffbind_centered.gz --perGroup --outFileName profile_plot_DN1_ATAC_TCF7_centered.pdf

plotHeatmap --matrixFile DN1_ATAC_TCF7_diffbind_centered.gz --outFileName heatmap_plot_DN1_ATAC_TCF7_centered.pdf --colorMap Reds