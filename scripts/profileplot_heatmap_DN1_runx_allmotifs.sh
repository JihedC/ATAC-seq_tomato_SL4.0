...
computeMatrix \
    ...
    --binSize 10 \
    --skipZeros \
    -o DN1_runx1_all_motif.gz 

plotProfile --matrixFile DN1_runx1_all_motif.gz --perGroup --outFileName profile_plot_DN1_runx1_all_motifs.pdf

plotHeatmap --matrixFile DN1_runx1_all_motif.gz --outFileName heatmap_plot_DN1_runx1_all_motifs.pdf --colorMap Reds