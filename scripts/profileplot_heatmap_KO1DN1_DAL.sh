...
computeMatrix \
    ...
    --binSize 10 \
    --skipZeros \
    -o KO1_DN1_ATAC_DAL.gz

plotProfile --matrixFile KO1_DN1_ATAC_DAL.gz --perGroup --outFileName profile_plot_KO1_DN1_ATAC_DAL.pdf

plotHeatmap --matrixFile KO1_DN1_ATAC_DAL.gz --outFileName heatmap_plot_KO1_DN1_ATAC_DAL.pdf --colorMap Reds